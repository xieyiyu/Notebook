    ...
    def dfs(i, j, k):
        ...
        if i-1 >= 0 and board[i-1][j] == word[k]:
            ...
            if dfs(i-1, j, k+1):
                return True
            board[i][j] = tmp
        if i+1 < n and board[i+1][j] == word[k]:
            tmp = board[i][j]
            board[i][j] = '#'
            if dfs(i+1, j, k+1):
                return True
        ...
        if j-1 >= 0 and board[i][j-1] == word[k]:
            ...
            if dfs(i, j-1, k+1):
                return True
            board[i][j] = tmp
        if j+1 < m and board[i][j+1] == word[k]:
            tmp = board[i][j]
            board[i][j] = '#'
            if dfs(i, j+1, k+1):
                return True
...
<div align="center"><img src="../../pics/leetcode/sudoku1.jpg"></div>
<div align="center"><img src="../../pics/leetcode/sudoku2.jpg"></div>
